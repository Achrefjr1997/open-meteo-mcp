...
def get_all_weather_variables() -> dict[str, dict[str, str]]:
    ...
    return {
        ...
        "soil_temperature_7_to_28cm": {
            "description": "Soil temperature at 7-28cm depth",
            "category": "temperature",
        },
        "soil_temperature_28_to_100cm": {
            "description": "Soil temperature at 28-100cm depth",
            "category": "temperature",
        },
        "soil_temperature_100_to_255cm": {
            "description": "Soil temperature at 100-255cm depth",
            "category": "temperature",
        },
        # Wind
        ...
        "soil_moisture_0_to_7cm": {
            "description": "Soil moisture at 0-7cm depth",
            "category": "soil",
        },
        "soil_moisture_7_to_28cm": {
            "description": "Soil moisture at 7-28cm depth",
            "category": "soil",
        },
        "soil_moisture_28_to_100cm": {
            "description": "Soil moisture at 28-100cm depth",
            "category": "soil",
        },
        "soil_moisture_100_to_255cm": {
            "description": "Soil moisture at 100-255cm depth",
            "category": "soil",
        },
        # Air Quality
        ...
        "et0_fao_evapotranspiration": {
            "description": "Evapotranspiration (ET0)",
            "category": "other",
        },
...
def get_all_weather_models() -> dict[str, dict[str, str]]:
    ...
    return {
        ...
        "ecmwf_ifs04": {
            "provider": "ECMWF",
            "description": "ECMWF IFS High Resolution (9km)",
            "resolution": "9km",
        },
        "gfs_global": {
            "provider": "NOAA",
            "description": "GFS Global Forecast System",
            "resolution": "25km",
        },
        ...
        "meteofrance_seamless": {
            ...
            "description": "Météo-France Seamless",
            "resolution": "2.5km",
        },
        "ukmo_uk": {
            "provider": "UK Met Office",
            "description": "UK Model (2km)",
            "resolution": "2km",
        },
        "metno_nordic": {
            "provider": "Met Norway",
            "description": "Met Norway Nordic",
            "resolution": "2.5km",
        },
        # Ensemble Models
        "icon_eps": {
            "provider": "DWD",
            "description": "ICON Ensemble Global",
            "resolution": "13km",
        },
        "icon_eps_eu": {
            "provider": "DWD",
            "description": "ICON Ensemble Europe",
            "resolution": "7km",
        },
        ...
        "ukmo_ensemble": {
            "provider": "UK Met Office",
            "description": "UK Met Office Ensemble",
            "resolution": "10km",
        },
    }
