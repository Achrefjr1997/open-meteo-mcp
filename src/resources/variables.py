                ...
                "common_combinations": {
                    ...
                    "combinations": {
                        ...
                        "detailed_forecast": [
                            ...
                            "cloud_cover", "pressure_msl", "uv_index"
                        ],
                        "marine_conditions": [
                        ...
                        "air_quality": [
                            ...
                            "european_aqi_pm2_5", "us_aqi_pm2_5"
                        ],
                        "solar_energy": [
...
_VARIABLES = {
    # Temperature
    "temperature_2m": {"description": "Air temperature at 2 meters above ground", "category": "temperature"},
    "temperature_2m_max": {"description": "Daily maximum temperature at 2 meters", "category": "temperature"},
    "temperature_2m_min": {"description": "Daily minimum temperature at 2 meters", "category": "temperature"},
    "apparent_temperature": {"description": "Apparent (feels-like) temperature", "category": "temperature"},
    "apparent_temperature_max": {"description": "Maximum apparent temperature", "category": "temperature"},
    "apparent_temperature_min": {"description": "Minimum apparent temperature", "category": "temperature"},
    "surface_temperature": {"description": "Surface temperature (ground level)", "category": "temperature"},
    "soil_temperature_0_7cm": {"description": "Soil temperature at 0-7 cm depth", "category": "temperature"},
    "soil_temperature_7_to_28cm": {"description": "Soil temperature at 7-28 cm depth", "category": "temperature"},
    "soil_temperature_28_to_100cm": {"description": "Soil temperature at 28-100 cm depth", "category": "temperature"},
    "soil_temperature_100_to_255cm": {"description": "Soil temperature at 100-255 cm depth", "category": "temperature"},
    "dewpoint_2m": {"description": "Dew point temperature at 2 meters", "category": "temperature"},
    "wetbulb_temperature_2m": {"description": "Wet bulb temperature at 2 meters", "category": "temperature"},
    
    # Wind
    "wind_speed_10m": {"description": "Wind speed at 10 meters above ground", "category": "wind"},
    "wind_direction_10m": {"description": "Wind direction at 10 meters (0-360°)", "category": "wind"},
    "wind_gusts_10m": {"description": "Wind gusts at 10 meters", "category": "wind"},
    "wind_speed_80m": {"description": "Wind speed at 80 meters (turbine height)", "category": "wind"},
    ...
    # Precipitation
    "precipitation": {"description": "Total precipitation (rain + snow + showers)", "category": "precipitation"},
    ...
    "total_column_integrated_water_vapour": {"description": "Total column water vapour", "category": "humidity"},
    
    # Solar
    "shortwave_radiation": {"description": "Shortwave radiation (Global Horizontal Irradiance)", "category": "solar"},
    ...
    "soil_moisture_7_to_28cm": {"description": "Soil moisture at 7-28 cm depth", "category": "soil"},
    "soil_moisture_28_to_100cm": {"description": "Soil moisture at 28-100 cm depth", "category": "soil"},
    "soil_moisture_100_to_255cm": {"description": "Soil moisture at 100-255 cm depth", "category": "soil"},
    "soil_moisture_index_0_to_7cm": {"description": "Soil moisture index at 0-7 cm", "category": "soil"},
    ...
    "nitrogen_dioxide": {"description": "Nitrogen dioxide (NO2) (μg/m³)", "category": "air_quality"},
    ...
    "boundary_layer_height": {"description": "Atmospheric boundary layer height", "category": "other"},
